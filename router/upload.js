...
const { getAvatar, postAvatar, getBookImg, postBookImg } = require('../controller/image_controller')
...
router.get('/bookImg', getBookImg)

router.post('/bookImg', upload.single('bookImg'), postBookImg)
